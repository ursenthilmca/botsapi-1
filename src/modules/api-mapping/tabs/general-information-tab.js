  ...
  return (
    <Fragment>
      <div className="page-scroll">
        <Row gutter={12} className="mt-15 px-10">
          <Col sm={8}>
        ...
        <Row className="mt-15 float-right px-10">
          <Col sm={24} className="">
            <Button
              icon={<EditIcon />}
              size={"large"}
              className="secondary-btn d-flex flex-gap-1 align-items-center justifiy-content-center"
            >
              Edit
            </Button>
          </Col>
