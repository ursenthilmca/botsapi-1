          ...
          <Row gutter={12} className="mt-15">
            <Col sm={8}>
              <FiledCard title={"API Name"}>
                <PrimaryLabel normal={true} className="text-20 font-normal">
                  API Name
                </PrimaryLabel>
              </FiledCard>
            </Col>
          ...
          <Row gutter={12} className="mt-20">
            <Col sm={12}>
              <FiledCard title={"API Test URL"}>
                <PrimaryLabel
                  normal={true}
                  className="text-20 font-normal text-info"
                >
                  apitesturlapitesturlapitesturlapitesturl
                </PrimaryLabel>
              </FiledCard>
            </Col>
            <Col sm={12}>
          ...
          <Row className="mt-15 ">
            <Col sm={24} className="">
              <Button
                icon={<EditIcon />}
                size={"large"}
                className="secondary-btn d-flex flex-gap-half align-items-center justifiy-content-center"
              >
                Edit
              </Button>
            </Col>
